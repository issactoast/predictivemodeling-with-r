...
housing_recipe <- all_data %>% 
  ...
  step_dummy(all_of(nominal_col), one_hot = TRUE) %>% 
  step_meanimpute(all_predictors()) %>%
  step_robust_normalize(all_predictors()) %>%
...
write.csv(submission, row.names = FALSE,
          "robustelasticnet_tuned_w_outliersrm_group.csv")
```
